  ...
  return (
    <div className="zap-root">
      <div className="zap-bg">
        ...
        >
          ...
          >
            <div>
              ...
              <h1
                className="zap-display zap-white"
                style={{
                  fontWeight: 700,
                  fontSize: 42,
                  lineHeight: 1.1,
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
                ...
                >
                  Статус разработки <ChevronRight size={14} />
                </a>
              </div>
            </div>
            <HeroTerminal />
        ...
        >
          <div className="zap-section-tag">
            <span className="n">#</span>
            <h2 className="zap-display zap-section-title">возможности</h2>
          </div>
        ...
        <section id="status" className="zap-wrap" style={{ paddingBottom: 96 }}>
          <div className="zap-section-tag">
            <span className="n">#</span>
            <h2 className="zap-display zap-section-title">статус</h2>
          </div>
          <p className="zap-section-sub">
            программа ещё не готова к установке — здесь появится команда, когда
            будет релиз
          </p>
          <StatusTerminal />
        </section>
        ...
        <section className="zap-wrap" style={{ paddingBottom: 96 }}>
          <div className="zap-section-tag">
            <span className="n">#</span>
            <h2 className="zap-display zap-section-title">
              что происходит внутри
            </h2>
          </div>
          <p className="zap-section-sub">
            упрощённый пример журнала работы ядра
          </p>
          <DosTerminal />
        </section>
        ...
        <section id="faq" className="zap-wrap" style={{ paddingBottom: 110 }}>
          <div className="zap-section-tag">
            <span className="n">#</span>
            <h2 className="zap-display zap-section-title">faq</h2>
          </div>
